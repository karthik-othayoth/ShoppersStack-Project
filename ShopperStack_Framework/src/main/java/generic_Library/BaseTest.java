...
public class BaseTest implements FrameWorkConstants {
	...
	/*
	 * Every Test Script should extent to BaseTest class.
	 * In BaseTest we have methods for pre-conditions and post-conditions.
	 *  
	 */	
	...
	public void extentReportSetUp() {
		sparkReporter = new ExtentSparkReporter("./Reports/" + utility_Methods.getNameForExtentReport() + ".html");
